...
Dia.addEventListener('click',function(){
    ...
    imagen0.style.background = "";
    imagen1.style.background = "";
    imagen2.style.background = "";
    imagen3.style.background = "";
    imagen4.style.background = "";
    imagen5.style.background = "";
...
Noche.addEventListener('click',function(){
    ...
    imagen0.style.background = "#cccccc9f";
    imagen1.style.background = "#cccccc9f";
    imagen2.style.background = "#cccccc9f";
    imagen3.style.background = "#cccccc9f";
    imagen4.style.background = "#cccccc9f";
    imagen5.style.background = "#cccccc9f";
